...
:::note
Cloudflare recommends [migrating from Vercel to Workers](/workers/static-assets/migration-guides/vercel-to-workers/) instead of Pages. Workers supports serverless functions, server-side rendering and more platform features such as [Durable Objects](/durable-objects/) and [built-in observability](/workers/observability/).
:::
